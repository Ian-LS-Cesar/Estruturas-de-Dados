public class Main {
    public static void main(String[] args) {
        ...
        minhaLista.insert(3, 4);
        minhaLista.insert(6, 55);
        System.out.println(minhaLista);
        System.out.println("Removendo: "+minhaLista.removeByIndex(3));
        System.out.println("Removendo: "+minhaLista.removeFirst());
        System.out.println(minhaLista);
    }
}
...
class LinkedList<E> implements List<E>{
    ...
    public E removeByIndex(int index) throws EmptyListException, IndexOutOfBoundsException {
        ...
        if(index == 0){
            ...
            auxNode1.next = auxNode2.next.next;
            auxNode2.next = null;
            size--;
        }
